...
DEFAULT_EVALUATOR_PROMPT = Path(__file__).resolve().parents[1] / "prompts" / "evaluator_prompts.txt"
...
def score_metric_bundle(
    ...
    prompt_path = Path(metrics_config.get("evaluator_prompt_path", DEFAULT_EVALUATOR_PROMPT))
