...
def build_agents(config: dict[str, Any], prompts_dir: str | Path | None = None) -> list[BaseAgent]:
    ...
    prompts_dir = prompts_dir or community_config.get("prompts_dir") or DEFAULT_PROMPTS_DIR
    agents: list[BaseAgent] = []
